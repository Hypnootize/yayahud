...
**2)** Copy the yayahud folder (**NOT** yayahud-Master, the one inside it!)

**3)** Paste The folder to your custom tf folder (C:\Program Files (x86)\Steam\SteamApps\common\Team Fortress 2\tf\custom\yayahud)
...
The original rgb code for the damage numbers is: hud_combattext_red 240; hud_combattext_green 240; hud_combattext_blue 20
